...
function getMediaSourceValue(e, a, t) {
    ...
    return null != r ? t.hasOwnProperty(r) && (r = t[r]) : r = a,
    r
}
function getCampaignValue(e, a) {
    for (let a of e)
        if (getParameterFromURL(a))
            return getParameterFromURL(a);
    return null != a ? a : document.getElementsByTagName("title")[0] ? document.getElementsByTagName("title")[0].innerText : "unknown"
}
...
function setGenericParameter(e, a, t, r=null) {
    ...
    n ? (e[a] = n,
    console.debug(`${t} found. ${a} = ${n}`)) : null != r ? (e[a] = r,
    console.debug(`${t} not found. ${a} = ${r}`)) : console.debug(`${t} not found and newParamValue is null. Skipping.`)
}
class OneLinkUrlGenerator {
    constructor({oneLinkURL: e, pidKeysList: a=[], pidStaticValue: t=null, campaignKeysList: r=[], campaignStaticValue: n=null, pidOverrideList: s=[], gclIdParam: i="af_sub5"}={}) {
        if (console.debug("Constructing OneLink URL generator"),
        void 0 === e || "string" != typeof e || "" === e)
            return console.error("OneLinkUrlGenerator: oneLinkURL arg invalid"),
            null;
        this.oneLinkURL = e,
        this.pidOverrideList = s,
        this.gclIdParam = i,
        this.pidKeysList = a,
    ...
    generateUrl() {
        if (null == this.mediaSource)
            return console.debug("No valid pid value was found. URL will no be changed"),
            null;
        if (getParameterFromURL("af_redirect"))
            ...
            null;
        if (isFacebook())
            return console.debug("This user comes from a paid Facebook ad - don't do anything. \nKeep direct app store links."),
            null;
        ...
        if (a) {
            ...
            e && (this.afParams.af_keywords = e,
            console.debug("There is a keyword associated with the ad"))
        } else
            console.debug("This user comes from SRN or custom network ");
        const t = this.oneLinkURL + "?pid=" + e + "&c=" + this.campaign + stringifyAfParameters(this.afParams);
        return console.debug(`Generated OneLink URL ${t}`),
        t
    }
